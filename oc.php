...
<!--					</div>-->
				...
				<div class="row m-0 justify-content-center">
					<div class="col-sm-12 col-md-4 col-lg-3 oc-person">
						<img src="./assets/images/oc/Dr Herath.jpg" width="100%">
						<div class="oc-person-details text-center">
							<div class="py-3">
								<h5>Dr. Damayanthi Herath</h5>
								<small>Workshop & Tutorial Chair</small>
							</div>
						</div>
					</div>
					<div class="col-sm-12 col-md-4 col-lg-3 oc-person">
...
<div class="modal fade" id="keynote-speaker-four" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
	    <div class="modal-content">
	      <div class="modal-header">
	      	<h4 class="modal-title speaker-title">Professor Lin Lin Li</h4>
