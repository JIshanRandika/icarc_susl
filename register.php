...
<body>
	...
	<section class="continer-fluid padding subpage-section" id="details">
		<div class="container pt-5">
			...
			Registration is now open for ICARC 2023. Find the best matching conference ticket for you.
			</p>
			...
			<!-- <div class="subpage-sec-content my-5" data-aos="fade-up" data-aos-duration="1700">
				...
				<h5>Conference Package:</h5>
					...
					<div class="sub-title-paras mb-3">
						...
						<p>
						<!-- <div style="display:inline-block;">Each accepted paper needs at least one author registration by February 15th, 2023 and should upload a clear scanned copy or a photo of the bank slip.</div> -->
						</p>
						<p align="justify">	
						At least one Author from each accepted paper should register by February 15th, 2023 and should upload a clear
						...
						Please adhere to the following file name format.
						 ...
						 <p>
              			File Name Format: &lt;ICARC2023_Paper ID_Last name&gt;. pdf
