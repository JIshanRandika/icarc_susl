	        ...
	        <div class="subpage-header-content text-center" >
	            <div class="subpage-header-text-div">
	                <div class="subpage-title-div">
	                   <!-- <h1 class="subpage-header-title"><span style="color: #f7ce0f;">Camera Ready</span> Paper Submission</h1> -->
	...
	<section class="continer-fluid padding subpage-section tp-track-sec" id="details">
		<div class="container pt-5">
            ...
            <div class="subpage-sec-content mb-5 crs-sec" data-aos="fade-up" data-aos-duration="1800">
                <h5 style="padding-top: 20px;">Key Steps in the Camera-Ready Process</h5>
                <div style="  display: block;  list-style-type: decimal;  margin-top: 1em;  margin-bottom: 1em;  margin-left: 0;  margin-right: 0;  padding-left: 40px;">
            ...
            <div class="subpage-sec-content mb-4 crs-sec" data-aos="fade-up" data-aos-duration="2000">
                <h5 style="padding-top: 20px;">1. Register for the Conference</h5>
                <div style="display:inline-block;">
                    Each accepted paper has to have one author registered as a full attendee. More details about registrations can be found <a href="http://www.icarc.sab.ac.lk/register">here</a>.
                </div>
            </div>
            <div class="subpage-sec-content mb-4 crs-sec" data-aos="fade-up" data-aos-duration="2200">
                <h5 style="padding-top: 20px;">2. Submit Your Copyright Consent</h5>
                <p>
            ...
            <div class="subpage-sec-content mb-4 crs-sec" data-aos="fade-up" data-aos-duration="2400">
                ...
                <div style="  display: block;  list-style-type: decimal;  margin-top: 1em;  margin-bottom: 1em;  margin-left: 0;  margin-right: 0;  padding-left: 40px;">
                    ...
                    <li>Please submit your final manuscript by the February 8, 2021 (no extension will be provided).</li>
                    <li>Each camera ready submission must strictly adhere to the formatting instructions in order to be included in the ICARC 2021 Proceedings.</li>
