	...
	<section class="continer-fluid padding subpage-section tp-track-sec" id="details">
		<div class="container pt-5">
			<!-- <div class="subpage-sec-content my-5 crs-sec" id="crs-sec" data-aos="fade-up" data-aos-duration="1600">
				<p>
                Hopefully, you have visited this web page because your research paper has been accepted to be presented at the2021 International Conference on Advanced Research in Computing 2022, which will be held from 23 - 24 February 2022.
                </p>
            ...
            <!-- <div class="subpage-sec-content mb-4 crs-sec" data-aos="fade-up" data-aos-duration="2400">
                ...
                <ol>
                    ...
                    <li>Please submit your final manuscript by the February 8, 2022 (no extension will be provided).</li>
                    <li>Each camera ready submission must strictly adhere to the formatting instructions in order to be included in the ICARC 2022 Proceedings.</li>
