...
<head>
    ...
    <script>
        ...
        $(document).ready(function(){
            // $('#alert-popup').modal();
            $(".countdown").jCounter({
                date: '23 february 2022 00:00:00',
                timezone: "Asia/Colombo",
                fallback: function() { console.log("Welcome to SUSL-ACRC 2022"); }
            });
        });
    </script>
</head>
        ...
        <div class="bg-color-red">
            ...
            <div class="header-content text-center" >
                ...
                <div class="header-text-div">
                    <div class="title-div">
                       <h1 class="header-title"><div style="color: #ffffff;display:inline-block;">International Conference on</div> <br><div style="color: #ffffff;display:inline-block;">Advanced </div> <div style="color: #487edb;display:inline-block;"> Research</div> in <div style="color: #f7ce0f;display:inline-block;">Computing</div><br><div style="color: #ffffff;display:inline-block;">2022</div></h1>
                       <!-- <h1 class="header-title">International Conference on<br>Advanced <span style="color: #f7ce0f;">Research</span> in Computing<br><span style="color: #f7ce0f;">2022</span></h1> -->
                       
                    </div>
                    
                    <div class="date-location-div mt-5">
                        <span class="date"><i class="fal fa-calendar-alt fa-lg" style="color: #f7ce0f;"></i>&nbsp; 23 - 24 Feb, 2022</span>
            ...
            <div class="row justify-content-between">
                <div class="col-sm-12 col-md-7 p-0 about-handle">
                    <div class="abt-sec-title" data-aos="fade-up" data-aos-duration="1300">
                        <h1 style="padding-top: 20px;"><div style="display:inline-block;">About ICARC 2022</div></h1>
                    ...
                    <div class="abt-sec-para" id="abt-section-para" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <p><div style="display:inline-block;">The 2</div><div style="vertical-align: super;font-size: small;display:inline-block;">nd</div> International Conference on Advanced Research in Computing ICARC - 2022 organized by the Department of Computing and Information Systems is scheduled to be held on 23<div style="vertical-align: super;font-size: small;display:inline-block;">rd</div> and 24<div style="vertical-align: super;font-size: small;display:inline-block;">th</div> February 2022. In an era of accelerated digital transformation brought on by the COVID-19 pandemic, the conference will be held under the theme
                        ...
                        <p><div style="display:inline-block;">ICARC 2022 is technically co-sponsored by the Institute of Electrical and Electronic Engineers, with the papers presented being submitted to IEEE Xplore digital library.</div></p>
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 keynote-speaker handle-speaker" id="keynote-speaker-one">
                                    ...
                                    <div class="keynote-speaker-details text-center px-2">
                                        ...
                                        IEEE Asia Pacific (Region 10) Director-Elect 2021-2022
                                        </p>
                                    </div>
                                </div>
