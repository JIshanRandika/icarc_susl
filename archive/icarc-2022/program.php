    ...
    <header class="subpage-header">
	        ...
	        <div class="subpage-header-content text-center" >
	            <div class="subpage-header-text-div">
	                <div class="subpage-title-div">
	                   <h1 class="subpage-header-title"><div style="color: #f7ce0f;display:inline-block;"> Program </div>  </h1>
	                </div>
	 ...
	 <section class="continer-fluid padding subpage-section cfp-track-sec" id="details">
        ...
        <center class ="col-sm-12 col-md-12 col-lg-12">
         ...
         <object data="./assets/resources/ICARC2022_Program_Book.pdf" type="application/pdf" width="100%" height="900px"> 
            <p>It appears you don't have a PDF plugin for this browser.
            No worries... you can <a href="./assets/resources/ICARC2022_Program_Book.pdf">click here to
            download the PDF file.</a></p>  
            </object>
		<!-- <embed src="./assets/resources/Program_book v6.pdf" width="800px" height="2100px" /> -->
        </center>
		</div>
