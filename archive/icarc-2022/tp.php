	        ...
	        <div class="subpage-header-content text-center" >
	            <div class="subpage-header-text-div">
	                <div class="subpage-title-div">
	                   <h1 class="subpage-header-title"><div style="color: #ffffff;display:inline-block;">Technical </div> <div style="color: #f7ce0f;display:inline-block;">Program</div> <div style="color: #ffffff;display:inline-block;">Guideline</div></h1>
	                </div>
	            </div>
        ...
        <div class="container pt-5">
            <div class="subpage-sec-content my-5" id="tp-sec" data-aos="fade-up" data-aos-duration="1900">
                <div style=" display: block;list-style-type: disc;margin-top: 1em;margin-bottom: 1 em;margin-left: 0;margin-right: 0;padding-left: 40px;">
                    ...
                    <div style=" display: list-item;"><div style="color: ##000000;display:inline-block;font-weight: bold;">Review Process :</div>   
                    ...
                    <div style=" display: list-item;"><div style="color: ##000000;display:inline-block;font-weight: bold;">Quality of Paper:</div>  </br>     
                        <p>
                            ...
                            <p>
                            During the Desk review process (prior to the formal double blind review) the scope and the formatting of the papers will be checked. Non-complying such as; </br>
