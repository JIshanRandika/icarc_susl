	...
	<section class="continer-fluid padding subpage-section program-sec" id="details">
		<div class="container pt-5">
            <div class="subpage-sec-title text-center" data-aos="fade-up" data-aos-duration="1100">
                <h1 style="padding-top: 20px;">Oral Presentations</h1>
        ...
        <div class="row justify-content-center mt-5 text-center" id="call-for-papers-download-btns">
					<a href="resources/Abstracts_ICARC2021.pdf" download class="theme-btn">Download </br> Abstracts of the Proccedings </a>
        </div>           
