	        ...
	        <div class="subpage-header-content text-center" >
	            <div class="subpage-header-text-div">
	                <div class="subpage-title-div">
	                   <!-- <h1 class="subpage-header-title">Call For <span style="color: #f7ce0f;">Papers</span></h1> -->
	                ...
	                <div class="subpage-header-text mt-4">
	                    <p>
	                    	ICARC 2021 is now calling for full paper submission. Prospective authors are invited to<br>submit their full papers with 06 pages maximum.
	                    </p>
	                </div>
	            </div>
		...
		<div class="container pt-5">
				...
				<table class="table table-borderless table-striped bg-light mt-3">
		            <tbody>
		                <tr>
		                    ...
		                    <div >	Machine Learning, Natural Language Processing, Sentiment Analysis, Deep Learning & AI, Statistics , Data Storage, Management and Innovation, Big Data Analytics, Business Analytics, Data Science Techniques for Handling Epidemics and Pandemics, Image and Video Processing and Analysis.</div>
		                    </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
		                    ...
		                    <td>
							<div style="color: ##000000;display:inline-block;font-weight: bold;">Human-Computer Interaction : </div><br>
		                    <div >	Human-computer interaction ,Speech, Graphic, Haptic, and Multimodal Interaction, Cross-Cultural Design, Virtual, Mixed, and Augmented Reality Interfaces and Systems, Artificial Intelligence in HCI.</div>
		                    </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
		                    ...
		                    <div >	Software Engineering Methodologies, SOA and Service-Oriented Systems, Software & System Quality of Service, Software Engineering Techniques and Production Perspectives, Continuous software engineering, Formal methods applied to software engineering, Human and social aspects of software engineering.</div>
		                    </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
		                    ...
		                    <div >	Computing research papers which are not  categorized under the above tracks are welcome here.</div>
		                    </td>
		                </tr>
		            </tbody>
		        </table>
			...
			<div data-aos="fade-up" data-aos-duration="1600">
				...
				<div class="row justify-content-center mt-5 text-center" id="call-for-papers-download-btns">
					<a href="resources/Author_Guidelines.pdf" download class="theme-btn">Author Guidelines</a>
					<a href="resources/Paper_Template.docx" download class="theme-btn ml-3 mr-2">Paper Template</a>
					<a href="resources/Flyer_ICARC2021.jpg" download class="theme-btn mr-3 ml-2">Download Flyer</a>
					<a href="https://cmt3.research.microsoft.com/ICARC2021" target="_blank" class="theme-btn">Submit Online</a>
				</div>
			</div>
		</div>
